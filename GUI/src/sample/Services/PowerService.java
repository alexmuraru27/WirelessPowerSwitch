...
public class PowerService extends Service<Void> {
    private final String ip;
    private final String port;
    private final String name;
    private final String hash;

    public PowerService(String name, String ip, String port, String hash) {
        this.ip = ip;
        this.port = port;
        this.name=name;
        this.hash=hash;
    ...
    protected Task<Void> createTask() {
        return new Task<>() {
            ...
            protected Void call() {
                try {
                    URL url=new URL("http://"+ip+":"+port+"/power?key="+hash);
